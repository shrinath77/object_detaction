...
image2 = image2.resize((1550, 1000), Image.ANTIALIAS)
...
#
label_l1 = tk.Label(root, text="..Object Detection and Display Count Using Deep Learning..",font=("Times New Roman", 35, 'bold'),
